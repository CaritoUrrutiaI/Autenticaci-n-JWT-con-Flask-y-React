      ...
      <nav className="navbar navbar-expand-lg  navbarColor textoTamañoMediano px-0 mb-0">
        <nav className="navbar ps-3">
          <div className="container-fluid">
            <Link to="/" className="text-decoration-none navbar-brand ps-2 navbarFontColor textoTamañoGrande">
                Home
              <i className="fa-solid   navbarFontColor textoTamañoGrande"></i>
            </Link>
          </div>
        </nav>
        ...
        <li className="navbar-nav pe-3 ps-1">
          <Link
            to="/login"
            className="text-decoration-none nav-link  navbarFontColor"
            href="#"
          >
            {datauser ? datauser?.info_user.email : "Login"}
          </Link>
          <Link
            to="/signup"
            className="text-decoration-none nav-link  navbarFontColor"
